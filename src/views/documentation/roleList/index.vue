  ...
  <div class="table-container">
    <vab-query-form>
      <el-form ref="form" :inline="true" :model="queryForm" @submit.native.prevent>
        <el-form-item>
          <el-input v-model="queryForm.title" placeholder="请输入角色名称" />
        </el-form-item>
        <el-form-item>
    ...
    <el-table ref="tableSort" v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText" :height="height">
      ...
      <el-table-column label="角色名称" prop="account" />
      <el-table-column label="是否启用" prop="name" show-overflow-tooltip />
      <el-table-column label="角色描述" prop="phone" />
      <el-table-column label="角色排序" prop="email" />
